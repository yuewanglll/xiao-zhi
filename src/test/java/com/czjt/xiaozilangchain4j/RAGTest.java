...
//并使用默认的文档解析器TextDocumentParser对文档进行解析
        Document document = FileSystemDocumentLoader.loadDocument("D:\\Demo_html\\xuecheng\\xiaozhi\\测试.txt");
...
//    }
    ...
    public void testParsePDF() {
        Document document = FileSystemDocumentLoader.loadDocument(
                "D:\\Demo_html\\xuecheng\\xiaozhi\\xiaozhi.pdf",
    ...
    public void testReadDocumentAndStore() {
        //使用FileSystemDocumentLoader读取指定目录下的知识库文档,并使用默认的文档解析器对文档进行解析(TextDocumentParser)
        Document document = FileSystemDocumentLoader.loadDocument("D:\\Demo_html\\xuecheng\\xiaozhi\\测试test.md");
